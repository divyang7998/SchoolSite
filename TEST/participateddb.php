...
<?php
include("config.php");
$sql="select participate.rollno, participate.eventid, fname,lname from participate join student on participate.rollno=student.rollno;";
echo "<p style='color:Black;'>"."Student Participation Data"."</p>";
